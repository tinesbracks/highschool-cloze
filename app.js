...
come true 表示梦想成真，come round 表示苏醒或再度出现，come out 表示出现、出版或结果出来，都不能表达“历史课本因故事而变得栩栩如生”。`, synonym: "come alive 与 stories make textbooks 生动化呼应。" }
  ...
  "practice-2-2024-new-gaokao-i": {
    ...
    questions: [
      { id: 41, part: "verb", answer: "won", options: ["knew", "held", "won", "quit"], clueType: "动作与名词关系", clue: "friend / a marathon race / Feeling motivated", clueTargets: ["motivated", "marathon"], logic: "朋友赢得马拉松才会激励作者开始跑步。", synonym: "won 与 achievements / motivated 呼应。" },
      { id: 42, part: "adjective", answer: "regularly", options: ["regularly", "silently", "proudly", "recently"], clueType: "副词描述动作状态", clue: "started running / motivated", clueTargets: ["started-running"], logic: "受到激励后开始规律跑步，regularly 合理描述训练状态。", synonym: "regularly 与 started running 的习惯动作对应。" },
      { id: 43, part: "verb", answer: "training", options: ["asking", "looking", "waiting", "training"], clueType: "动作对象", clue: "for a super / 52.4-mile double marathon", clueTargets: ["super-marathon"], logic: "参加超长马拉松前应是 training for。", synonym: "training 与 marathon 同场。" },
      { id: 44, part: "verb", answer: "hated", options: ["made", "believed", "hated", "deserved"], clueType: "情感转折", clue: "To be honest / pure boredom of jogging", clueTargets: ["boredom"], logic: "后文说慢跑无聊，说明作者讨厌这次长跑。", synonym: "hated 与 boredom 负向呼应。" },
      { id: 45, part: "noun", answer: "achievement", options: ["advantage", "achievement", "contribution", "influence"], clueType: "名词复现", clue: "other folks' achievements / my longest run", clueTargets: ["achievements", "longest-run"], logic: "女孩的 double marathon 让作者自己的 15 miles 成就显得小。", synonym: "achievement 原文复现。" },
      { id: 46, part: "noun", answer: "reason", options: ["way", "risk", "place", "reason"], clueType: "逻辑条件", clue: "if a big dog was running after me", clueTargets: ["big-dog"], logic: "除非有大狗追，这是再次跑步的唯一理由。", synonym: "reason 与 if 条件对应。" },
      { id: 47, part: "verb", answer: "turned to", options: ["gave up", "went on", "turned to", "dealt with"], clueType: "动作转换", clue: "So / cycling / got a good bike", clueTargets: ["cycling", "good-bike"], logic: "放弃跑步后转向骑行，turn to 表示转而开始。", synonym: "turned to 与 cycling 新方向呼应。" },
      { id: 48, part: "verb", answer: "dreamed", options: ["heard", "dreamed", "complained", "approved"], clueType: "动作与宾语", clue: "entering cycle races", clueTargets: ["cycle-races"], logic: "骑了很多后梦想参加自行车比赛。", synonym: "dreamed of entering 是固定搭配。" },
      { id: 49, part: "verb", answer: "borrowed", options: ["painted", "borrowed", "bought", "parked"], clueType: "上下文动作", clue: "visit my sister / her bike / went for a ride", clueTargets: ["sister-bike"], logic: "在姐姐家，她上班时作者借了她的自行车去骑。", synonym: "borrowed 与 her bike 对应。" },
      { id: 50, part: "noun", answer: "problem", options: ["problem", "secret", "principle", "advice"], clueType: "后文解释", clue: "roads went through large valleys / uphill for miles", clueTargets: ["uphill"], logic: "冒号后解释困难，所以是 problem。", synonym: "problem 与 uphill for miles 负向解释对应。" },
      { id: 51, part: "noun", answer: "challenges", options: ["dangers", "events", "opponents", "challenges"], clueType: "名词概括", clue: "uphill for miles / I'd never faced", clueTargets: ["uphill"], logic: "连续上坡是作者从未面对过的挑战。", synonym: "challenges 与 problem / uphill 呼应。" },
      { id: 52, part: "verb", answer: "passed", options: ["passed", "convinced", "admired", "stopped"], clueType: "动作场景", clue: "100 local bikers / used to such roads", clueTargets: ["local-bikers"], logic: "当地骑手习惯山路，所以他们超过了作者。", synonym: "passed 与 bikers / roads 同场。" },
      { id: 53, part: "adjective", answer: "appealing", options: ["reliable", "convenient", "familiar", "appealing"], clueType: "情感变化", clue: "got passed / riding my bike didn't seem quite as", clueTargets: ["got-passed"], logic: "被很多骑手超过后，骑车不再那么有吸引力。", synonym: "not appealing 与挫败感对应。" },
      { id: 54, part: "verb", answer: "matured", options: ["traveled", "matured", "missed", "worried"], clueType: "结尾升华", clue: "I've come to accept", clueTargets: ["come-accept"], logic: "能接受自己的目标，说明作者变成熟了。", synonym: "matured 与 come to accept 呼应。" },
      { id: 55, part: "noun", answer: "goals", options: ["limits", "dates", "goals", "tests"], clueType: "主旨名词", clue: "set for myself / my own", clueTargets: ["my-own"], logic: "set goals for myself 是合理搭配，也是全文主旨。", synonym: "goals 与目标属于自己呼应。" }
    ],
    sentenceData: [
  ...
  "practice-3-2024-new-gaokao-i": {
    ...
    questions: [
      { id: 41, part: "verb", answer: "settle", options: ["study", "rent", "visit", "settle"], clueType: "动作逻辑顺序", clue: "buy a house in Europe / Italy was the clear winner / permanent home", clueTargets: ["buy-house", "permanent-home"], logic: "买房和 permanent home 指向长期定居，所以是 settle。", synonym: "settle 与 permanent home 复现。" },
      { id: 42, part: "verb", answer: "struggled", options: ["planned", "struggled", "refused", "happened"], clueType: "转折线索", clue: "ask for directions or order in a restaurant / locals smiled", clueTargets: ["ask-order", "locals-smiled"], logic: "第一次到意大利语言不通，问路点餐都很吃力。", synonym: "struggled 与 language barrier 呼应。" },
      { id: 43, part: "verb", answer: "string", options: ["string", "hang", "mix", "match"], clueType: "动词短语", clue: "a sentence of Italian together", clueTargets: ["sentence-italian"], logic: "string a sentence together 表示拼凑句子。", synonym: "string together 与 sentence 搭配。" },
      { id: 44, part: "verb", answer: "praised", options: ["improved", "assessed", "admired", "praised"], clueType: "后文情绪", clue: "That encouragement", clueTargets: ["encouragement"], logic: "locals 的反应带来 encouragement，说明他们表扬了作者。", synonym: "praised 与 encouragement 直接对应。" },
      { id: 45, part: "noun", answer: "barrier", options: ["course", "barrier", "area", "test"], clueType: "名词对应", clue: "ask for directions / sentence of Italian", clueTargets: ["ask-order", "sentence-italian"], logic: "语言困难是 language barrier。", synonym: "barrier 与 struggled 使用语言呼应。" },
      { id: 46, part: "adjective", answer: "warm-hearted", options: ["open-minded", "strong-willed", "warm-hearted", "well-informed"], clueType: "例子归纳", clue: "bring me cheese / remind me to close the window", clueTargets: ["bring-cheese", "close-window"], logic: "邻居送奶酪、提醒关窗，说明意大利人热心。", synonym: "warm-hearted 与 kindness 呼应。" },
      { id: 47, part: "verb", answer: "remind", options: ["remind", "allow", "persuade", "order"], clueType: "动作目的", clue: "close the window in my car when rain is coming", clueTargets: ["close-window"], logic: "下雨前来门口提醒作者关车窗。", synonym: "remind 与 when rain is coming 对应。" },
      { id: 48, part: "noun", answer: "acts", options: ["tricks", "promises", "acts", "duties"], clueType: "名词概括", clue: "bring cheese / remind me / kindness", clueTargets: ["bring-cheese", "kindness"], logic: "送奶酪和提醒关窗都是善意行为 acts of kindness。", synonym: "acts of kindness 固定表达。" },
      { id: 49, part: "noun", answer: "appetite", options: ["ambition", "success", "appetite", "growth"], clueType: "语境提示", clue: "foodie / through my stomach", clueTargets: ["foodie", "stomach"], logic: "美食家和胃口语境锁定 appetite。", synonym: "appetite 与 foodie / stomach 同场。" },
      { id: 50, part: "noun", answer: "dish", options: ["costume", "dish", "symbol", "tale"], clueType: "名词对应", clue: "recipe passed from one generation to another", clueTargets: ["recipe"], logic: "每个城镇有传统菜肴，每个家庭保留食谱。", synonym: "dish 与 recipe 复现。" },
      { id: 51, part: "verb", answer: "gather", options: ["gather", "cheer", "leave", "wait"], clueType: "动作场景", clue: "for big meals on Sundays", clueTargets: ["big-meals"], logic: "家庭会为了大餐聚在一起 gather。", synonym: "gather 与 friends and family 大餐呼应。" },
      { id: 52, part: "verb", answer: "come up with", options: ["put up with", "stand up for", "come up with", "make up for"], clueType: "短语含义", clue: "whatever other excuses they can", clueTargets: ["excuses"], logic: "想出借口用 come up with excuses。", synonym: "come up with 与 excuses 搭配。" },
      { id: 53, part: "verb", answer: "accompanied", options: ["signaled", "confirmed", "represented", "accompanied"], clueType: "动作关系", clue: "meals / laughter and joy", clueTargets: ["laughter-joy"], logic: "这些饭局总是伴随着笑声和快乐。", synonym: "accompanied by 与 laughter and joy 搭配。" },
      { id: 54, part: "noun", answer: "disadvantages", options: ["disadvantages", "meanings", "surprises", "opportunities"], clueType: "让步逻辑", clue: "Whatever ... life in Italy might have / the problems", clueTargets: ["problems"], logic: "后文 problems 指向生活中的不利之处。", synonym: "disadvantages 与 problems 同向。" },
      { id: 55, part: "verb", answer: "forgotten", options: ["created", "forgotten", "understood", "identified"], clueType: "情感收束", clue: "once you sit down to a big meal with friends and family", clueTargets: ["friends-family"], logic: "与亲友围坐大餐时，问题被忘记。", synonym: "forgotten 与 laughter and joy 的正向氛围呼应。" }
    ],
    sentenceData: [
      { en: `When I decided to buy a house in Europe ten years ago, I didn't think too long.`, zh: "十年前，当我决定在欧洲买房时，我没有想太久。", html: `When I decided to <span data-clue="buy-house">buy a house in Europe</span> ten years ago, I didn't think too long.` },
      { en: `I liked traveling in France, but when it came to picking my favorite spot to settle, Italy was the clear winner.`, zh: "我喜欢在法国旅行，但说到选择我最喜欢的定居地点，意大利显然胜出。", html: `I liked traveling in France, but when it came to picking my favorite spot to <button class="blank-token" data-qid="41">41</button>, Italy was the clear winner.` },
      { en: `During my first visit to Italy, I struggled to ask for directions or order in a restaurant.`, zh: "第一次到意大利时，我问路或在餐馆点餐都很吃力。", html: `During my first visit to Italy, I <button class="blank-token" data-qid="42">42</button> to <span data-clue="ask-order">ask for directions or order in a restaurant</span>.` },
      { en: `But every time I tried to string a sentence of Italian together, the locals smiled at me and praised my language skills.`, zh: "但每次我努力拼凑一句意大利语时，当地人都会对我微笑并表扬我的语言能力。", html: `But every time I tried to <button class="blank-token" data-qid="43">43</button> a <span data-clue="sentence-italian">sentence of Italian together</span>, the <span data-clue="locals-smiled">locals smiled at me</span> and <button class="blank-token" data-qid="44">44</button> my language skills.` },
      { en: `That encouragement helped me to get through the language barrier.`, zh: "那种鼓励帮助我克服了语言障碍。", html: `That <span data-clue="encouragement">encouragement</span> helped me to get through the language <button class="blank-token" data-qid="45">45</button>.` },
      { en: `After I made Italy my permanent home, I discovered how warm-hearted Italians are.`, zh: "在我把意大利作为永久的家之后，我发现意大利人是多么热心。", html: `After I made Italy my <span data-clue="permanent-home">permanent home</span>, I discovered how <button class="blank-token" data-qid="46">46</button> Italians are.` },
      { en: `Neighbors will bring me freshly made cheese and will come to my door to remind me to close the window in my car when rain is coming.`, zh: "邻居会给我送来新做的奶酪，也会在快下雨时到我门口提醒我关上车窗。", html: `Neighbors will <span data-clue="bring-cheese">bring me freshly made cheese</span> and will come to my door to <button class="blank-token" data-qid="47">47</button> me to <span data-clue="close-window">close the window in my car when rain is coming</span>.` },
      { en: `It's these small acts of kindness that make a new country feel like home.`, zh: "正是这些小小的善意行为让一个新国家感觉像家一样。", html: `It's these small <button class="blank-token" data-qid="48">48</button> of <span data-clue="kindness">kindness</span> that make a new country feel like home.` },
      { en: `As a foodie, the way to my heart is through my stomach, and nowhere fuels my appetite quite like Italy.`, zh: "作为一个美食爱好者，通向我内心的路是经过我的胃，没有哪里像意大利这样激发我的胃口。", html: `As a <span data-clue="foodie">foodie</span>, the way to my heart is through my <span data-clue="stomach">stomach</span>, and nowhere fuels my <button class="blank-token" data-qid="49">49</button> quite like Italy.` },
      ...
      { en: `Families gather for big meals on Sundays, birthdays, and whatever other excuses they can come up with.`, zh: "家人们会在周日、生日以及他们能想到的任何其他理由下聚在一起吃大餐。", html: `Families <button class="blank-token" data-qid="51">51</button> for <span data-clue="big-meals">big meals</span> on Sundays, birthdays, and whatever other <span data-clue="excuses">excuses</span> they can <button class="blank-token" data-qid="52">52</button>.` },
      { en: `These meals are always accompanied by laughter and joy.`, zh: "这些餐食总是伴随着笑声和快乐。", html: `These meals are always <button class="blank-token" data-qid="53">53</button> by <span data-clue="laughter-joy">laughter and joy</span>.` },
      { en: `Whatever disadvantages life in Italy might have, the problems are forgotten once you sit down to a big meal with friends and family.`, zh: "无论意大利生活可能有什么不便，一旦你和朋友家人坐下来吃一顿大餐，问题都会被忘记。", html: `Whatever <button class="blank-token" data-qid="54">54</button> life in Italy might have, the <span data-clue="problems">problems</span> are <button class="blank-token" data-qid="55">55</button> once you sit down to a big meal with <span data-clue="friends-family">friends and family</span>.` }
    ],
  ...
  "practice-4-2024-beijing": {
    ...
    questions: [
      { id: 1, part: "noun", answer: "announcement", options: ["assignment", "initiative", "announcement", "interview"], clueType: "名词对应内容", clue: "Today at 1:10 there will be auditions", clueTargets: ["auditions-notice"], logic: "引号内容是学校通知，所以是 announcement。", synonym: "announcement 与 Today at 1:10... 通知内容对应。" },
      { id: 2, part: "noun", answer: "interest", options: ["hesitancy", "interest", "worry", "regret"], clueType: "名词对应状态", clue: "but I'd try out because my friends were doing it", clueTargets: ["friends-doing"], logic: "她本来对 drama 没兴趣，只是朋友去所以尝试。", synonym: "no interest 与 because my friends were doing it 呼应。" },
      { id: 3, part: "noun", answer: "line", options: ["game", "show", "play", "line"], clueType: "地点场景", clue: "outside the drama room / Everyone looked energetic", clueTargets: ["outside-drama"], logic: "面试前戏剧教室外排起队伍，a line。", synonym: "line 与 outside the room 候场对应。" },
      { id: 4, part: "adjective", answer: "suddenly", options: ["suddenly", "continuously", "originally", "generally"], clueType: "心理变化", clue: "I hadn't expected / now that I was doing it / felt nervous", clueTargets: ["hadnt-expected", "felt-nervous"], logic: "原本没想到会站在这里，真正开始时突然紧张。", synonym: "suddenly 与心理突变对应。" },
      { id: 5, part: "verb", answer: "tested", options: ["advertised", "tested", "challenged", "polished"], clueType: "面试动作", clue: "my singing skills / auditions", clueTargets: ["singing-skills", "auditions-notice"], logic: "老师在面试中测试歌唱能力。", synonym: "tested 与 auditions / skills 同场。" },
      { id: 6, part: "noun", answer: "chance", options: ["demand", "credit", "dream", "chance"], clueType: "情绪判断", clue: "teachers were smiling and praising me / A big role", clueTargets: ["smiling-praising"], logic: "老师表扬让她觉得自己有机会，所以要求大角色。", synonym: "chance 与 praising / big role 呼应。" },
      { id: 7, part: "verb", answer: "posted", options: ["traded", "posted", "questioned", "claimed"], clueType: "名单动作", clue: "the cast list / checked", clueTargets: ["cast-list"], logic: "演员名单被张贴出来，大家去查看。", synonym: "posted 与 list checked 对应。" },
      { id: 8, part: "verb", answer: "well up", options: ["well up", "roll in", "stand out", "go off"], clueType: "情绪动作", clue: "I was so happy / name at the top", clueTargets: ["so-happy"], logic: "看到自己拿到主角，开心到眼泪涌上来，well up。", synonym: "well up 与 so happy 情绪强烈对应。" },
      { id: 9, part: "verb", answer: "clapping", options: ["whispering", "arguing", "clapping", "stretching"], clueType: "舞台反馈", clue: "on stage / gave me a boost of confidence", clueTargets: ["on-stage", "confidence"], logic: "舞台上观众鼓掌会提升信心。", synonym: "clapping 与 boost of confidence 对应。" },
      { id: 10, part: "adjective", answer: "braver", options: ["funnier", "fairer", "cleverer", "braver"], clueType: "结尾升华", clue: "trying something new / stepping out of my comfort zone", clueTargets: ["trying-new", "comfort-zone"], logic: "尝试新事物、走出舒适区让她更勇敢。", synonym: "braver 与 stepping out of comfort zone 呼应。" }
    ],
    sentenceData: [
      { en: `I'd just arrived at school, ready for another school day.`, zh: "我刚到学校，准备开始又一个上学日。", html: `I'd just arrived at school, ready for another school day.` },
      { en: `I was reading a book in the classroom when there was an announcement.`, zh: "我正在教室里读书，这时有了一则通知。", html: `I was reading a book in the classroom when there was an <button class="blank-token" data-qid="1">1</button>.` },
      ...
      { en: `My friends all jumped up in excitement and asked me, Will you be going, Amy?`, zh: "我的朋友们都兴奋地跳起来问我：Amy，你会去吗？", html: `My friends all jumped up in excitement and asked me, Will you be going, Amy?` },
      { en: `Sure, I said. I had no interest in drama, but I'd try out because my friends were doing it.`, zh: "当然，我说。我对戏剧并没有兴趣，但我会去试试，因为我的朋友们都去了。", html: `Sure, I said. I had no <button class="blank-token" data-qid="2">2</button> in drama, but I'd try out because <span data-clue="friends-doing">my friends were doing it</span>.` },
      { en: `At 1:10, there was a line outside the drama room.`, zh: "一点十分，戏剧教室外排起了一队。", html: `At 1:10, there was a <button class="blank-token" data-qid="3">3</button> <span data-clue="outside-drama">outside the drama room</span>.` },
      ...
      { en: `But now that I was doing it, I suddenly felt nervous.`, zh: "但现在真的在做这件事时，我突然感到紧张。", html: `But now that I was doing it, I <button class="blank-token" data-qid="4">4</button> <span data-clue="felt-nervous">felt nervous</span>.` },
      { en: `What if I wasn't any good?`, zh: "如果我不够好怎么办？", html: `What if I wasn't any good?` },
      { en: `I entered the room and the teachers made me say some lines from the musical.`, zh: "我走进房间，老师们让我念音乐剧中的几句台词。", html: `I entered the room and the teachers made me say some lines from the musical.` },
      { en: `They then tested my singing skills and asked what role I wanted to play.`, zh: "然后他们测试了我的歌唱能力，并问我想演什么角色。", html: `They then <button class="blank-token" data-qid="5">5</button> my <span data-clue="singing-skills">singing skills</span> and asked what role I wanted to play.` },
      { en: `The teachers were smiling and praising me.`, zh: "老师们微笑着表扬我。", html: `The teachers were <span data-clue="smiling-praising">smiling and praising me</span>.` },
      { en: `I felt like I had a chance, so I said, A big role.`, zh: "我觉得自己有机会，于是说：一个大角色。", html: `I felt like I had a <button class="blank-token" data-qid="6">6</button>, so I said, A big role.` },
      { en: `They said they'd look into it. I started getting really nervous.`, zh: "他们说会考虑。我开始变得非常紧张。", html: `They said they'd look into it. I started getting really nervous.` },
      { en: `Soon, the cast list was posted.`, zh: "很快，演员名单被张贴出来。", html: `Soon, the <span data-clue="cast-list">cast list</span> was <button class="blank-token" data-qid="7">7</button>.` },
      { en: `My friends checked and came back shouting, Amy, you got the main role!`, zh: "我的朋友们去查看后跑回来喊：Amy，你拿到主角了！", html: `My friends checked and came back shouting, Amy, you got the main role!` },
      { en: `Sure enough, my name was at the top.`, zh: "果然，我的名字在最上面。", html: `Sure enough, my name was at the top.` },
      { en: `I just stared at it and started to well up. I was so happy.`, zh: "我只是盯着它，开始热泪盈眶。我太高兴了。", html: `I just stared at it and started to <button class="blank-token" data-qid="8">8</button>. I was <span data-clue="so-happy">so happy</span>.` },
      { en: `After two months we were all prepared and ready to go on stage.`, zh: "两个月后，我们都准备好了，可以上台了。", html: `After two months we were all prepared and ready to go <span data-clue="on-stage">on stage</span>.` },
      { en: `It was fun. And when people started clapping, that gave me a boost of confidence.`, zh: "这很有趣。当人们开始鼓掌时，这给了我信心的提升。", html: `It was fun. And when people started <button class="blank-token" data-qid="9">9</button>, that gave me a boost of <span data-clue="confidence">confidence</span>.` },
      { en: `It stayed with me and made me feel braver.`, zh: "这种感觉一直伴随着我，让我觉得更勇敢。", html: `It stayed with me and made me feel <button class="blank-token" data-qid="10">10</button>.` },
      { en: `I realised that by trying something new, I can have fun-even if it means stepping out of my comfort zone.`, zh: "我意识到，通过尝试新事物，我可以获得乐趣，即使这意味着走出舒适区。", html: `I realised that by <span data-clue="trying-new">trying something new</span>, I can have fun-even if it means <span data-clue="comfort-zone">stepping out of my comfort zone</span>.` }
    ],
...
let questions = articleData["mock-2026-05-13-homeless-cats"].questions;
let sentenceData = articleData["mock-2026-05-13-homeless-cats"].sentenceData;
let glossary = articleData["mock-2026-05-13-homeless-cats"].glossary;
