...
demand 是需求，support 是支持，excuse 是借口，都不能准确表达“对农业产生新的认识和珍视”。`, synonym: "appreciation 与 agriculture / taken for granted 对应。" },
      { id: 15, part: "verb", answer: "reconnect", options: ["deal", "part", "compete", "reconnect"], clueType: "动词短语搭配", clue: "with their farming roots", clueTargets: ["farming-roots"], logic: `空格后是 with their farming roots。最自然的动词短语是 reconnect with，表示与自己的农业根源重新建立联系。
deal with 是处理，part with 是放弃或割舍，compete with 是与……竞争，都不能和 farming roots 表达“回到根源、重新连接”的文章主旨。`, synonym: "reconnect with 与 roots 是固定语义搭配。" }
    ],
    sentenceData: [
